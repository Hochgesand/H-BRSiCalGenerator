...
public class EmailSendingService {
    ...
    public String getCalenderOverEmail(@RequestBody MeetingIdsAndEmailDTO meetingIdsAndEmailDTO) {
        ...
        try {
            ...
            helper.setTo(meetingIdsAndEmailDTO.getEmail());
            helper.setSubject("Dein Kalender");
            helper.setText("Hier ist dein Kalender :)");

            helper.addAttachment("Calendar.ics", new ByteArrayResource(calenderExportService.createCalender(meetingIdsAndEmailDTO)));
